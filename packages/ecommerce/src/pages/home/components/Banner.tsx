...
const Banner = () => {
  return (
    <div className='relative h-[calc(100vh-6.5rem)] before:bg-black before:bg-opacity-50 before:dark:bg-opacity-25 before:content-[""] before:w-full before:h-full before:absolute'>
      <img src={bannerImg} alt='Banner' className='h-full w-full' />
